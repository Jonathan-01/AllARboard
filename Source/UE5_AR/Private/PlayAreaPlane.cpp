...
void APlayAreaPlane::AddVertex(FVector point) 
{
	...
	UKismetSystemLibrary::PrintString(this, ("X: " + FString::FromInt(point.X) + "\tY: " + FString::FromInt(point.Y)), true, true, FLinearColor(0.2, 0.66, 1, 1), 2);
	...
	for (int j = 0; j < Vertices.Num(); j++)
	{
		...
		for (int i = 0; i < Vertices.Num(); i++) 
		{
			...
			if (!sortedArray.Contains(Vertices[i])) 
			{
				...
				{
					//UKismetSystemLibrary::PrintString(this, "Vertex " + FString::FromInt(i) + " Stage 1", true, true, FLinearColor(0.2, 1.0, 0.2, 1), 200);
				...
				{
					//UKismetSystemLibrary::PrintString(this, "Vertex " + FString::FromInt(i) + " Stage 2", true, true, FLinearColor(0.2, 1.0, 0.2, 1), 200);
				...
				{
					//UKismetSystemLibrary::PrintString(this, "Vertex " + FString::FromInt(i) + " Stage 3", true, true, FLinearColor(0.2, 1.0, 0.2, 1), 200);
				...
				{
					//UKismetSystemLibrary::PrintString(this, "Vertex " + FString::FromInt(i) + " Stage 4", true, true, FLinearColor(0.2, 1.0, 0.2, 1), 200);
...
void APlayAreaPlane::UpdatePlanePolygonMesh()
{
	...
	for (int i = 2; i < PolygonMeshVerticesNum; i++)
	{
		...
		//GEngine->AddOnScreenDebugMessage(-1, 8.0f, FColor::Yellow, TEXT("Added Indexes"));
	}
